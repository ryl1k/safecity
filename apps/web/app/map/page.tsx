...
const restoreOpen = { display: 'inline-flex', alignItems: 'center', minHeight: '2.4em', padding: '0 0.9em', borderRadius: '2em', border: 'none', background: 'none', color: 'var(--sc-primary)', fontFamily: 'inherit', fontWeight: 800, fontSize: '0.9em', cursor: 'pointer' } as const;
