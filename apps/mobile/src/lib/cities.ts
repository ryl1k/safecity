...
// ported verbatim from apps/web/src/lib/cities.ts (generated together with
// the importer's showcase list). Persistence uses AsyncStorage instead of
// localStorage.
...
export async function saveCity(id: string): Promise<void> {
  try {
